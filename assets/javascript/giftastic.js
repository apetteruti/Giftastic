$(document).ready(function () {
  ...
  function gifMovement() {
    ...
    if (state == "still") { //if the state is moving
      $(this).attr("src", animatedImage); //then change the src so that it's pulling the still image from the api
      $(this).attr("data-state", "data-animate"); //change the data state to still
    } else { //otherwise if the state is still...
      $(this).attr("src", stillImage); //change the src so that it's pulling the moving image from the api
      $(this).attr("data-state", "data-still"); //change the data state to animate
    }
  };
  ...
  $(document).on("click", ".gif", gifMovement);
